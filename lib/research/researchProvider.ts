      ...
      professionals: [
        {
          ...
          currentRole: `Staff Engineer & AI Founder (formerly AWS, Netlify)`,
          company: "Latent Space / Independent",
          startingPoint: "Finance analyst with non-technical degree",
          careerSteps: ["Investment Analyst", "Full-Stack Web Developer", "Developer Advocate (Netlify)", "Senior DevRel Engineer (AWS)", `Staff ${targetRole} / AI Engineer`],
          skills: ["Learning in Public", "Open Source Architecture", "API Integration", "Technical Writing"],
          experiences: ["Built widely adopted open-source developer tooling", "Authored comprehensive technology breakdowns with thousands of readers"],
          transitions: "Pivoted by building in public: shipped open-source utilities and wrote deep technical teardowns that attracted inbound job offers without relying on traditional pedigree.",
          relevanceToCandidate: "Directly proves that producing inspectable proof-of-work and publishing project artifacts overcomes non-traditional or early-career backgrounds.",
          sources: [
            { title: "Swyx Career Essays & The Coding Career Handbook", url: "https://www.swyx.io", snippet: "Documentation of transitioning into senior engineering via public evidence.", isControlledFallback: true },
          ],
        },
        {
          name: "Kelsey Hightower",
          currentRole: `Distinguished Systems Architect & Advisor`,
          company: "Independent / Formerly Google Cloud",
          startingPoint: "Helpdesk customer support specialist without formal CS degree",
          careerSteps: ["Helpdesk Technician", "System Administrator", "Open Source Contributor (Puppet)", "Staff Solutions Architect", "Principal Engineer (Google Cloud)"],
          skills: ["System Architecture", "Open Source Tooling", "Technical Storytelling", "Container Orchestration"],
          experiences: ["Authored 'Kubernetes The Hard Way'", "Contributed key enhancements to open source infrastructure"],
          transitions: "Rose through tech by deconstructing complex systems and releasing hands-on, verifiable blueprints that became the industry standard.",
          relevanceToCandidate: "Shows how mastering end-to-end architecture and publishing step-by-step technical guides builds instant authority and credibility.",
          sources: [
            { title: "Kubernetes The Hard Way & Public Career Talks", url: "https://github.com/kelseyhightower/kubernetes-the-hard-way", snippet: "Open-source trajectory reference demonstrating technical authority through shared blueprints.", isControlledFallback: true },
          ],
        },
        {
          name: "Julia Evans",
          currentRole: `Principal Infrastructure Engineer & Technical Author`,
          company: "Wizard Zines / Formerly Stripe",
          startingPoint: "Junior math graduate with limited systems background",
          careerSteps: ["Data Analyst", "Junior Backend Developer", "Infrastructure Engineer (Stripe)", "Principal Author & Tool Creator"],
          skills: ["Systems Debugging", "Linux Internals", "Technical Communication", "Network Observability"],
          experiences: ["Authored widely used diagnostic utilities", "Built critical deployment tooling for high-traffic financial platforms"],
          transitions: "Accelerated from junior developer to principal engineer by relentlessly investigating edge cases, writing diagnostic tools, and publishing illustrated architectural guides.",
          relevanceToCandidate: "Illustrates that mastering debugging, telemetry, and system visibility makes an engineer indispensable to hiring teams.",
          sources: [
            { title: "Julia Evans Technical Archive & Case Studies", url: "https://jvns.ca", snippet: "Documented engineering progression through systems diagnostics and problem isolation.", isControlledFallback: true },
          ],
        },
      ],
      routes: [
